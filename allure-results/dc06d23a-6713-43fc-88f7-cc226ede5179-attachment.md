...
Call log:
  - waiting for getByRole('button', { name: 'Navigation Commands' })
          ...
          - generic [ref=e210]:
            ...
            - generic [ref=e212]:
              ...
              - generic [ref=e223]:
                ...
                - textbox "Date" [ref=e225]: 2026-05-07
                - generic [ref=e226]:
                  - generic [ref=e227]:
                    - generic [ref=e228]: id
                    - text: =profile-date
            ...
            - generic [ref=e233]:
              ...
              - radiogroup "Profession" [ref=e235]:
                ...
                - generic [ref=e238] [cursor=pointer]:
                  - radio "Automation Tester" [checked] [ref=e239]
            ...
            - generic [ref=e247]:
              ...
              - generic "Automation tools" [ref=e249]:
                ...
                - generic [ref=e252] [cursor=pointer]:
                  - checkbox "Protractor" [checked] [ref=e253]
                  - text: Protractor
            ...
            - generic [ref=e261]:
              ...
              - generic "Continents" [ref=e263]:
                - generic [ref=e264] [cursor=pointer]:
                  - checkbox "Asia" [checked] [active] [ref=e265]
                  - text: Asia
...
```ts
  ...
  4  |   await page.goto(
  5  |     "https://app.thetestingacademy.com/playwright/tables/practice",
  6  |   );
  7  | 
  8  |   // Verify the personal informatiopn
  9  |   await page.fill("#first-name", "Sanjay");
  10 |   await page.fill("#last-name", "Kumar");
  11 |   await page.getByTestId("gender-male").click();
  12 | 
  13 |   await page.locator("#years-experience").selectOption("7");
  14 |   await page.locator('#profile-date').fill('2026-05-07');
  15 | 
  16 |   await page.getByTestId("profession-automation").click();
  17 |   await page.getByTestId("tool-protractor").click();
  18 |   await page.getByTestId("continent-asia").click();
> 19 |   await page.getByRole("button", { name: "Navigation Commands" }).click();
     |                                                                   ^ Error: locator.click: Test timeout of 30000ms exceeded.
  20 | 
  21 |   const navigationCMD = await page
  22 |     .locator("#selenium-tab-panel")
  23 |     .allTextContents();
  24 |   console.log("All Navigation Command Printed :", navigationCMD);
  25 | });
  26 | 
```