...
- Name: ExerciseTopics\ComparingMethod.spec.ts >> Comparing methods
- Location: tests\ExerciseTopics\ComparingMethod.spec.ts:4:1
...
Call log:
  - waiting for locator('product-title').nth(1)
            ...
            - generic [ref=e209]:
              - heading "14.1-inch Laptop" [level=2] [ref=e210]:
                - link "14.1-inch Laptop" [ref=e211] [cursor=pointer]:
                  - /url: /141-inch-laptop
              - generic "1624 review(s)" [ref=e212]
              - generic [ref=e215]:
...
```ts
  ...
  3  | 
  4  | test("Comparing methods" ,async ({page})=>{
  5  |   await page.goto("https://demowebshop.tricentis.com")
  6  |   const products:Locator = page.locator('product-title');
  7  | 
  8  |   // innerText() Vs textContent()
  9  |   
> 10 |   console.log(await products.nth(1).innerText());
     |                                     ^ Error: locator.innerText: Test timeout of 30000ms exceeded.
  11 |   console.log(await products.nth(1).textContent());
  12 | })
```